...
<div class="panel panel-danger">
	<div class="panel-heading" align="center"><h4>Purchase Report</h4></div>
	<div class="panel-body">
		...
		<table class="table">
			...
			<tbody>
				...
				$q = mysqli_query($dbc,"SELECT * FROM purchase WHERE (purchase_date BETWEEN '$f_date' AND '$t_date') AND client_name='$customer_id'"); 
			}elseif($f_date > 0 AND $t_date>0){

				$q = mysqli_query($dbc,"SELECT * FROM purchase WHERE (purchase_date BETWEEN '$f_date' AND '$t_date') "); 
			}else{

				$q = mysqli_query($dbc,"SELECT * FROM purchase WHERE client_name='$customer_id' "); 
			}?>
