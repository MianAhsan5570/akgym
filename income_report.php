...
<div class="panel panel-danger">
	<div class="panel-heading" align="center"><h4>Income Report</h4></div>
	<div class="panel-body">
		...
		<table class="table">
			...
			<tbody>
				<?php $i=1; 
				$q = mysqli_query($dbc,"SELECT * FROM vouchers WHERE (voucher_date BETWEEN '$f_date' AND '$t_date') "); ?>
				...
				<tr>
					<th><?=$i?></th>
					<th><?=date('D, d-M-Y',strtotime($r['voucher_date']))?></th>
					<th>From Voucher</th>
					<th><?= $r['voucher_amount']?></th>
