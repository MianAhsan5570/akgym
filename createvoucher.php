		...
		<form class="form-horizontal" method="POST" action="" id="">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-4">
			      ...
			      <select class="form-control searchableselect" id="plan" name="plan" autofocus="true" >
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			    			<div class="input-group">
			    				<select class="form-control" id="clientName" name="customer_id"  required style="z-index: 1">
						      	<option value="">~~SELECT~~</option>
						      	<?php 
