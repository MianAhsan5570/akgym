	...
	<div class="panel-body">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <button type="button" class="btn btn-success" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..." style="float: right;"> <i class="glyphicon glyphicon-plus-sign"></i>More Shopping </button>
      ...
      <div class="modal-body form-horizontal" style="max-height:500px; overflow:auto;" >
      	...
      	<div class="paymentOrderMessages"></div>
			  ...
			  <div class="form-group">
		 	  ...
		 	  <div class="form-group hidden col-sm-9" id="pending_order_area">
			   ...
			   <div class="form-group hidden col-sm-9" id="tracking_area">
			   ...
			   <div class="form-group hidden col-sm-9" id="reason_cancel_area">
