...
?>
<style>
   			form , input , select , button,.form-group,.form-control{
   				margin: 1px;
   				padding: 1px;
   				font-size: 12px;
   			}
...
<div class="panel panel-default">
	...
	<div class="panel-heading">
		...
		<?php if($_GET['o'] == 'add') { ?>
  		...
  		<a href='orderslist.php?o=manord' style="color: white !important; " ><button class='btn btn-info pull pull-right' style="margin-top: -7px;"> 
  		<span class="glyphicon glyphicon-list"></span> &nbsp List of Orders</button></a>
