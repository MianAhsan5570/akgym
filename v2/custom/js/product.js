...
$(document).ready(function() {
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			if(arate == "" || arate != "") {
				//$("#arate").after('<p class="text-danger">Quantity field is required</p>');
				//$('#arate').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#arate").find('.text-danger').remove();
				// success out for form 
				$("#arate").closest('.form-group').addClass('has-success');	  	
			}	// /else
			if(dscrp == "" ) {
				$("#dscrp").after('<p class="text-danger">Quantity field is required</p>');
				$('#dscrp').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#dscrp").find('.text-danger').remove();
				// success out for form 
				$("#dscrp").closest('.form-group').addClass('has-success');	  	
			}	// /else
			...
			if(weight== "") {
				$("#weight").after('<p class="text-danger">Weight field is required</p>');
				$('#weight').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#weight").find('.text-danger').remove();
				// success out for form 
			...
			if( productName && quantity && rate && weight && brandName && categoryName && productStatus) {
		...
		$.ajax({
		  ...
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
					...
					if(arate == "") {
						$("#arate").after('<p class="text-danger">Rate field is required</p>');
						$('#arate').closest('.form-group').addClass('has-error');
					}	else {
						// remov error text field
						$("#arate").find('.text-danger').remove();
