...
<head>
  ...
  <style>
    /* Make select2 height equal to Bootstrap input height */
    .select2-selection {
...
<body style="padding-top: 70px">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
          ...
          <li><a href="./" class="navbar-brand"><img src="img/uploads/<?=$logo?>" width="80" height="60" class="img img-responsive" style="margin-top:-12px"></a>
          </ul>
